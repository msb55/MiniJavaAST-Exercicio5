...
public class msb5_las3Parser extends Parser {
	...
	public static final int
		...
		WHITE_SPACE=38, SINGLE_LINE_COMMENT=39, MULTI_LINE_COMENT=40;
	public static final String[] tokenNames = {
		...
		"WHITE_SPACE", "SINGLE_LINE_COMMENT", "MULTI_LINE_COMENT"
	};
	public static final int
		RULE_program = 0, RULE_mainclass = 1, RULE_classDeclaration = 2, RULE_varDecl = 3, 
		RULE_methodDecl = 4, RULE_type = 5, RULE_statement = 6, RULE_exp = 7, 
		RULE_identifier = 8;
	public static final String[] ruleNames = {
		"program", "mainclass", "classDeclaration", "varDecl", "methodDecl", "type", 
		"statement", "exp", "identifier"
	};

	@Override
	public String getGrammarFileName() { return "msb5_las3.g4"; }
	...
	public msb5_las3Parser(TokenStream input) {
		super(input);
	...
	public static class ProgramContext extends ParserRuleContext {
		...
		public TerminalNode EOF() { return getToken(msb5_las3Parser.EOF, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof msb5_las3Listener ) ((msb5_las3Listener)listener).enterProgram(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof msb5_las3Listener ) ((msb5_las3Listener)listener).exitProgram(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof msb5_las3Visitor ) return ((msb5_las3Visitor<? extends T>)visitor).visitProgram(this);
	...
	public static class MainclassContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof msb5_las3Listener ) ((msb5_las3Listener)listener).enterMainclass(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof msb5_las3Listener ) ((msb5_las3Listener)listener).exitMainclass(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof msb5_las3Visitor ) return ((msb5_las3Visitor<? extends T>)visitor).visitMainclass(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ClassDeclarationContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof msb5_las3Listener ) ((msb5_las3Listener)listener).enterClassDeclaration(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof msb5_las3Listener ) ((msb5_las3Listener)listener).exitClassDeclaration(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof msb5_las3Visitor ) return ((msb5_las3Visitor<? extends T>)visitor).visitClassDeclaration(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class VarDeclContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof msb5_las3Listener ) ((msb5_las3Listener)listener).enterVarDecl(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof msb5_las3Listener ) ((msb5_las3Listener)listener).exitVarDecl(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof msb5_las3Visitor ) return ((msb5_las3Visitor<? extends T>)visitor).visitVarDecl(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MethodDeclContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof msb5_las3Listener ) ((msb5_las3Listener)listener).enterMethodDecl(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof msb5_las3Listener ) ((msb5_las3Listener)listener).exitMethodDecl(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof msb5_las3Visitor ) return ((msb5_las3Visitor<? extends T>)visitor).visitMethodDecl(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class TypeContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof msb5_las3Listener ) ((msb5_las3Listener)listener).enterType(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof msb5_las3Listener ) ((msb5_las3Listener)listener).exitType(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof msb5_las3Visitor ) return ((msb5_las3Visitor<? extends T>)visitor).visitType(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StatementContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof msb5_las3Listener ) ((msb5_las3Listener)listener).enterStatement(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof msb5_las3Listener ) ((msb5_las3Listener)listener).exitStatement(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof msb5_las3Visitor ) return ((msb5_las3Visitor<? extends T>)visitor).visitStatement(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExpContext extends ParserRuleContext {
		...
		public TerminalNode INTEGER_LITERAL() { return getToken(msb5_las3Parser.INTEGER_LITERAL, 0); }
		public IdentifierContext identifier() {
			return getRuleContext(IdentifierContext.class,0);
		}
		public TerminalNode IDENTIFIER() { return getToken(msb5_las3Parser.IDENTIFIER, 0); }
		public ExpContext exp(int i) {
			return getRuleContext(ExpContext.class,i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof msb5_las3Listener ) ((msb5_las3Listener)listener).enterExp(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof msb5_las3Listener ) ((msb5_las3Listener)listener).exitExp(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof msb5_las3Visitor ) return ((msb5_las3Visitor<? extends T>)visitor).visitExp(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class IdentifierContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof msb5_las3Listener ) ((msb5_las3Listener)listener).enterIdentifier(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof msb5_las3Listener ) ((msb5_las3Listener)listener).exitIdentifier(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof msb5_las3Visitor ) return ((msb5_las3Visitor<? extends T>)visitor).visitIdentifier(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\2\2\u00a7\u00a8\7\5\2\2\u00a8\u00a9\7\22\2\2\u00a9\u00aa\7\33\2\2\u00aa"+
		"\u00ab\5\20\t\2\u00ab\u00ac\7\36\2\2\u00ac\u00b7\3\2\2\2\u00ad\u00ae\7"+
		"\5\2\2\u00ae\u00af\5\22\n\2\u00af\u00b0\7\23\2\2\u00b0\u00b1\7#\2\2\u00b1"+
		"\u00b7\3\2\2\2\u00b2\u00b3\7\23\2\2\u00b3\u00b4\5\20\t\2\u00b4\u00b5\7"+
